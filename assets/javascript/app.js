...
$('#start').on('click', function() {
    ...
    $('#timer').html("<h2>Vault 111 will close in: 20 Seconds</h2>" + "<br>");
...
function scoreChecker() {
    ...
    else if (userChoice2 == questions[0].answer) {
        rightAnswers++;
    }
    else {
        wrongAnswers++;
    ...
    else if (userChoice3 == questions[0].answer) {
        rightAnswers++;
    }
    else {
        wrongAnswers++;
    ...
    else if (userChoice4 == questions[0].answer) {
        rightAnswers++;
    }
    else {
        wrongAnswers++;
